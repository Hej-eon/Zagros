...
function drawZagrosHero(x,y){const X=x*TILE,Y=y*TILE;ctx.imageSmoothingEnabled=false;
ctx.fillStyle='#171a18';ctx.fillRect(X+12,Y+38,9,5);ctx.fillRect(X+28,Y+38,9,5);
ctx.fillStyle='#6b3f24';ctx.fillRect(X+11,Y+39,11,4);ctx.fillRect(X+27,Y+39,11,4);
ctx.fillStyle='#17202a';ctx.fillRect(X+15,Y+30,19,10);ctx.fillStyle='#242d35';ctx.fillRect(X+13,Y+32,8,8);ctx.fillRect(X+27,Y+32,8,8);
ctx.fillStyle='#f0d7a1';ctx.fillRect(X+12,Y+19,24,13);ctx.fillRect(X+15,Y+14,18,9);ctx.fillRect(X+18,Y+11,12,5);
ctx.fillStyle='#e8b83f';ctx.fillRect(X+22,Y+22,5,10);
ctx.fillStyle='#b33a3a';ctx.fillRect(X+13,Y+25,9,10);ctx.fillRect(X+27,Y+25,9,10);ctx.fillRect(X+20,Y+27,8,8);
ctx.fillStyle='#fff1d2';ctx.fillRect(X+13,Y+24,8,6);ctx.fillRect(X+28,Y+24,8,6);
ctx.fillStyle='#3a2020';ctx.fillRect(X+21,Y+17,3,3);ctx.fillRect(X+30,Y+17,3,3);
ctx.fillStyle='#d9a13a';ctx.fillRect(X+15,Y+8,18,5);ctx.fillRect(X+12,Y+10,24,4);
ctx.fillStyle='#b33a3a';ctx.fillRect(X+14,Y+7,20,4);ctx.fillStyle='#f0d7a1';ctx.fillRect(X+16,Y+5,16,3);
ctx.fillStyle='#fff1d2';ctx.fillRect(X+14,Y+6,20,2);ctx.fillStyle='#b33a3a';ctx.fillRect(X+12,Y+9,4,7);ctx.fillRect(X+32,Y+9,4,7);
ctx.fillStyle='#d9d1b9';ctx.fillRect(X+17,Y+8,3,2);ctx.fillRect(X+23,Y+7,3,2);ctx.fillRect(X+29,Y+8,3,2);
ctx.fillStyle='#e4b43c';ctx.fillRect(X+20,Y+33,9,3);ctx.fillStyle='#f4d35e';ctx.fillRect(X+21,Y+34,7,2);
